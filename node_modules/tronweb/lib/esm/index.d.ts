...
declare const _default: {
    utils: {
        ...
        isBigNumber(number: unknown): number is BigNumber;
        ...
        mapEvent(event: import("./utils/validations.js").EventQueryDataType): import("./utils/validations.js").MapEventQueryDataType;
        parseEvent(event: import("./utils/validations.js").EventQueryDataType, { inputs: abi }: {
            inputs: readonly Types.AbiParamsCommon[];
        }): import("./utils/validations.js").EventQueryDataType;
